  ...
  const sampleLeads = [
    {
      ...
      organizationId: '00000000-0000-0000-0000-000000000001', // Default org ID
      ...
      notes: 'Interested in Trek X-Caliber series',
      createdBy: 'system'
    },
    {
      id: 'lead_002', 
      ...
      notes: 'Needs e-bike for daily commute',
      createdBy: 'system'
    },
    {
      id: 'lead_003',
      ...
      notes: 'Price sensitive, looking for deals',
      createdBy: 'system'
    }
  ];

  sampleLeads.forEach(lead => {
    leadsDatabase.set(lead.id, lead);
  });

  console.log(`🗄️ Initialized leads database with ${sampleLeads.length} sample leads`);
}
